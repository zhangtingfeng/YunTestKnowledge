package cn.tedu.sp0ag4studio.common.web;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.actions.DispatchAction;
...
public class BaseAction extends DispatchAction {
     ...
     * 连接平台数据库用户
     */
    public Reader g4Reader = (Reader) getService("g4Reader");
