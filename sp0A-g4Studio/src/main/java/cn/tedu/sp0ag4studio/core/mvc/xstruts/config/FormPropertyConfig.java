...
public class FormPropertyConfig extends BaseConfig {
    ...
    public Class getTypeClass() {
        // Identify the cn.eggsoft.sp34pricereport.base class (in case an array was specified)
        ...
        // Construct an appropriate Class instance for the cn.eggsoft.sp34pricereport.base class
        ...
        // Return the cn.eggsoft.sp34pricereport.base class or an array appropriately
        if (indexed) {
