package cn.tedu.sp0ag4studio.core.orm.xibatis.support;
...
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.client.SqlMapClient;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.client.SqlMapClientBuilder;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.builder.xml.SqlMapConfigParser;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.builder.xml.SqlMapParser;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.builder.xml.XmlParserState;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.impl.ExtendedSqlMapClient;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.TransactionConfig;
    ...
    public void setTransactionConfigClass(Class transactionConfigClass) {
        if (transactionConfigClass == null || !TransactionConfig.class.isAssignableFrom(transactionConfigClass)) {
            throw new IllegalArgumentException("Invalid transactionConfigClass: does not implement "
                    + "cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.TransactionConfig");
        }
