...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionFormBean;
...
public class ConfigHelper implements ConfigHelperInterface {
     ...
     * mapping is being used to select the cn.eggsoft.sp34pricereport.controller servlet).</li>
     *
    ...
    /**
     * <p>
     * Renders the reference for a HTML <cn.eggsoft.sp34pricereport.base> element
     * </p>
     */
