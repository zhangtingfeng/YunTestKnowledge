...
public class ExceptionConfig extends BaseConfig {
     ...
     */
    protected String handler = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ExceptionHandler";
    ...
    public void inheritFrom(ExceptionConfig config) throws ClassNotFoundException, IllegalAccessException,
        ...
        if (getHandler().equals("cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ExceptionHandler")) {
    ...
    public void processExtends(ModuleConfig moduleConfig, ActionConfig actionConfig) throws ClassNotFoundException,
        ...
        if ((!extensionProcessed) && (ancestorType != null)) {
            ...
            // Check for circular inheritance and make sure the cn.eggsoft.sp34pricereport.base config's
