package cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.config;

import java.util.Iterator;

import cn.tedu.sp0ag4studio.core.orm.xibatis.common.beans.ClassInfo;
...
import cn.tedu.sp0ag4studio.core.orm.xibatis.common.resources.Resources;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.client.SqlMapException;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.client.extensions.TypeHandlerCallback;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.accessplan.AccessPlanFactory;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.CacheController;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.CacheModel;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.fifo.FifoCacheController;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.lru.LruCacheController;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.memory.MemoryCacheController;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.datasource.DbcpDataSourceFactory;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.datasource.JndiDataSourceFactory;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.datasource.SimpleDataSourceFactory;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.impl.SqlMapClientImpl;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.impl.SqlMapExecutorDelegate;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.mapping.result.Discriminator;
...
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.scope.ErrorContext;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.TransactionManager;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.external.ExternalTransactionConfig;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.jdbc.JdbcTransactionConfig;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.transaction.jta.JtaTransactionConfig;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.CustomTypeHandler;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.DomCollectionTypeMarker;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.DomTypeMarker;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.TypeHandler;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.TypeHandlerFactory;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.XmlCollectionTypeMarker;
import cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.type.XmlTypeMarker;
...
public class SqlMapConfiguration {
    ...
    private void registerDefaultTypeAliases() {
        ...
        // upon init
        typeHandlerFactory.putTypeAlias("OSCACHE", "cn.tedu.sp0ag4studio.core.orm.xibatis.sqlmap.engine.cache.oscache.OSCacheController");
