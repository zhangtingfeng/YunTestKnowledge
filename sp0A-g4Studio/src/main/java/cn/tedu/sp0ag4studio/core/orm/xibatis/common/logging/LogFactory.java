package cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging;
...
public class LogFactory {
    ...
    static {
        tryImplementation("org.apache.commons.logging.LogFactory",
                "cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.jakarta.JakartaCommonsLoggingImpl");
        tryImplementation("org.apache.log4j.Logger", "cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.log4j.Log4jImpl");
        tryImplementation("java.util.logging.Logger",
                "cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.jdk14.Jdk14LoggingImpl");
        tryImplementation("java.lang.Object", "cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.nologging.NoLoggingImpl");
    }
    ...
    public static synchronized void selectLog4JLogging() {
        try {
            ...
            Class implClass = Resources.classForName("cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.log4j.Log4jImpl");
            logConstructor = implClass.getConstructor(new Class[]{Class.class});
        } catch (Throwable t) {
        }
    }
    ...
    public static synchronized void selectJavaLogging() {
        try {
            ...
            Class implClass = Resources
                    .classForName("cn.tedu.sp0ag4studio.core.orm.xibatis.common.logging.jdk14.Jdk14LoggingImpl");
            logConstructor = implClass.getConstructor(new Class[]{Class.class});
        } catch (Throwable t) {
        }
    }
