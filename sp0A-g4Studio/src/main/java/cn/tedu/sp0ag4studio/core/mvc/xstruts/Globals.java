package cn.tedu.sp0ag4studio.core.mvc.xstruts;
...
public class Globals implements Serializable {
     ...
     * @since Struts 1.1
     */
    public static final String ACTION_SERVLET_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ACTION_SERVLET";
     ...
     * @since Struts 1.1
     */
    public static final String CANCEL_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.CANCEL";

    /**
     * <p>
     * The cn.eggsoft.sp34pricereport.base of the context attributes key under which our
     ...
     *
     * <p>
     * For each request processed by the cn.eggsoft.sp34pricereport.controller servlet, the
     ...
     * @since Struts 1.1
     */
    public static final String MODULE_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.MODULE";
     ...
     * @since Struts 1.2
     */
    public static final String MODULE_PREFIXES_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.globals.MODULE_PREFIXES";
     ...
     * @since Struts 1.3
     */
    public static final String ORIGINAL_URI_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.globals.ORIGINAL_URI_KEY";

    /**
     * The request attributes key under which your action should store an
     * <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionErrors</code> object, if
     * you are using the corresponding custom tag library elements.
     */
    public static final String ERROR_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ERROR";
     ...
     */
    public static final String EXCEPTION_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.EXCEPTION";
     ...
     */
    public static final String LOCALE_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.LOCALE";

    /**
     * The request attributes key under which our
     * <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.ActionMapping</code> instance is
     * passed.
     */
    public static final String MAPPING_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.mapping.instance";

    /**
     * The request attributes key under which your action should store an
     * <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionMessages</code> object,
     * if you are using the corresponding custom tag library elements.
     *
     * @since Struts 1.1
     */
    public static final String MESSAGE_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ACTION_MESSAGE";

    /**
     * <p>
     * The cn.eggsoft.sp34pricereport.base of the context attributes key under which our module
     ...
     * </p>
     */
    public static final String MESSAGES_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.MESSAGE";

    /**
     * The request attributes key under which our multipart class is stored.
     */
    public static final String MULTIPART_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.mapping.multipartclass";

    /**
     * <p>
     * The cn.eggsoft.sp34pricereport.base of the context attributes key under which an array of
     ...
     * @since Struts 1.1
     */
    public static final String PLUG_INS_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.PLUG_INS";
     ...
     * @since Struts 1.1
     */
    public static final String REQUEST_PROCESSOR_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.REQUEST_PROCESSOR";

    /**
     * The context attributes key under which we store the mapping defined for
     * our cn.eggsoft.sp34pricereport.controller serlet, which will be either a path-mapped pattern (
     * <code>/action/*</code>) or an extension mapped pattern (<code>*.do</code>
     * ).
     */
    public static final String SERVLET_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.SERVLET_MAPPING";

    /**
     * The session attributes key under which our transaction token is stored,
     * if it is used.
     */
    public static final String TRANSACTION_TOKEN_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.TOKEN";
     ...
     * @since Struts 1.1
     */
    public static final String XHTML_KEY = "cn.tedu.sp0ag4studio.core.mvc.xstruts.globals.XHTML";

    /**
     * The name of the taglib package.
     */
    public static final String TAGLIB_PACKAGE = "cn.tedu.sp0ag4studio.core.mvc.xstruts.taglib.html";
