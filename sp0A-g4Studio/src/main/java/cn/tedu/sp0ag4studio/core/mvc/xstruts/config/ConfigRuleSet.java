package cn.tedu.sp0ag4studio.core.mvc.xstruts.config;
...
public class ConfigRuleSet extends RuleSetBase {
     ...
     * <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ModuleConfig</code> is pushed
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addSetNext("struts-config/action-mappings/action", "addActionConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ActionConfig");
        ...
        digester.addObjectCreate("struts-config/action-mappings/action/exception",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ExceptionConfig", "className");
        ...
        digester.addSetNext("struts-config/action-mappings/action/exception", "addExceptionConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ExceptionConfig");
        ...
        digester.addSetNext("struts-config/action-mappings/action/forward", "addForwardConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ForwardConfig");

        digester.addRule("struts-config/action-mappings/action/forward/set-property", new BaseConfigSetPropertyRule());

        digester.addObjectCreate("struts-config/cn.eggsoft.sp34pricereport.controller", "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ControllerConfig",
                "className");
        digester.addSetProperties("struts-config/cn.eggsoft.sp34pricereport.controller");
        digester.addSetNext("struts-config/cn.eggsoft.sp34pricereport.controller", "setControllerConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ControllerConfig");

        digester.addRule("struts-config/cn.eggsoft.sp34pricereport.controller/set-property", new BaseConfigSetPropertyRule());
        ...
        digester.addSetNext("struts-config/form-beans/form-bean", "addFormBeanConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.FormBeanConfig");

        digester.addObjectCreate("struts-config/form-beans/form-bean/form-property",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.FormPropertyConfig", "className");
        ...
        digester.addSetNext("struts-config/form-beans/form-bean/form-property", "addFormPropertyConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.FormPropertyConfig");
        ...
        digester.addObjectCreate("struts-config/message-resources",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.MessageResourcesConfig", "className");
        ...
        digester.addSetNext("struts-config/message-resources", "addMessageResourcesConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.MessageResourcesConfig");

        digester.addRule("struts-config/message-resources/set-property", new BaseConfigSetPropertyRule());

        digester.addObjectCreate("struts-config/plug-in", "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.PlugInConfig");
        digester.addSetProperties("struts-config/plug-in");
        digester.addSetNext("struts-config/plug-in", "addPlugInConfig",
                "cn.tedu.sp0ag4studio.core.mvc.xstruts.config.PlugInConfig");
 ...
 * <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
 ...
 * be a <code>cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
