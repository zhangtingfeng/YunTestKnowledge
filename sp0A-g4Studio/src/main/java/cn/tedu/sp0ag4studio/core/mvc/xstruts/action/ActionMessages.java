...
public class ActionMessages implements Serializable {
     ...
     * </p>
     */
    public static final String GLOBAL_MESSAGE = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.GLOBAL_MESSAGE";
     ...
     *
     * <p>
     * The cn.eggsoft.sp34pricereport.controller uses this property to determine if session-scoped messages
     * can be removed.
     * </p>
     *
     * @since Struts 1.2
