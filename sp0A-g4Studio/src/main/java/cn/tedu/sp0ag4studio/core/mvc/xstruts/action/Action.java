...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.util.TokenProcessor;

/**
 * <p>
 * An <strong>Action</strong> is an adapter between the contents of an incoming
 * HTTP request and the corresponding business logic that should be executed to
 * process this request. The cn.eggsoft.sp34pricereport.controller (RequestProcessor) will select an
 * appropriate Action for each request, create an instance (if necessary), and
 * call the <code>execute</code> method.
 * </p>
 *
 * <p>
 * Actions must be programmed in a thread-safe manner, because the cn.eggsoft.sp34pricereport.controller
 ...
 *
 * <p>
 * When an <code>Action</code> instance is first created, the cn.eggsoft.sp34pricereport.controller will
...
public class Action {
     ...
     * </p>
     *
     * @param servlet The new cn.eggsoft.sp34pricereport.controller servlet, if any
     */
     ...
     * been skipped by the cn.eggsoft.sp34pricereport.controller servlet.
     * </p>
     *
     * <p>
