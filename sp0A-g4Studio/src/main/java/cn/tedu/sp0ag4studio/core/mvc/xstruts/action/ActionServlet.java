package cn.tedu.sp0ag4studio.core.mvc.xstruts.action;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ConfigRuleSet;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ExceptionConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.FormBeanConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.FormPropertyConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ForwardConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.MessageResourcesConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ModuleConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.ModuleConfigFactory;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.config.PlugInConfig;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.util.MessageResources;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.util.MessageResourcesFactory;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.util.ModuleUtils;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.util.RequestUtils;
...
public class ActionServlet extends HttpServlet {
     ...
     * </p>
     */
    protected String chainConfig = "cn/tedu/sp0ag4studio/core/mvc/xstruts/chain/chain-config.xml";
    ...
    /**
     * <p>
     * The Java cn.eggsoft.sp34pricereport.base name of our internal resources.
     * </p>
     *
     * @since Struts 1.1
     */
    protected String internalName = "cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionResources";
    ...
    protected String[] registrations = {"-//Apache Software Foundation//DTD Struts Configuration 1.0//EN",
            "/cn/tedu/sp0ag4studio/core/mvc/xstruts/resources/struts-config_1_0.dtd",
            "-//Apache Software Foundation//DTD Struts Configuration 1.1//EN",
            "/cn/tedu/sp0ag4studio/core/mvc/xstruts/resources/struts-config_1_1.dtd",
            "-//Apache Software Foundation//DTD Struts Configuration 1.2//EN",
            "/cn/tedu/sp0ag4studio/core/mvc/xstruts/resources/struts-config_1_2.dtd",
            "-//Apache Software Foundation//DTD Struts Configuration 1.3//EN",
            "/cn/tedu/sp0ag4studio/core/mvc/xstruts/resources/struts-config_1_3.dtd",
            "-//Sun Microsystems, Inc.//DTD Web Application 2.3//EN",
            "/cn/tedu/sp0ag4studio/core/mvc/xstruts/resources/web-app_2_3.dtd"};
    ...
    /**
     * <p>
     * Gracefully shut down this cn.eggsoft.sp34pricereport.controller servlet, releasing any resources
    ...
    /**
     * <p>
     * Initialize other global characteristics of the cn.eggsoft.sp34pricereport.controller servlet.
     * </p>
     *
     * @throws ServletException if we cannot initialize these resources
     */
    ...
    /**
     * <p>
     * Initialize the servlet mapping under which our cn.eggsoft.sp34pricereport.controller servlet is
    ...
    protected void initServlet() throws ServletException {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Scanning web.xml for cn.eggsoft.sp34pricereport.controller servlet mapping");
        }
