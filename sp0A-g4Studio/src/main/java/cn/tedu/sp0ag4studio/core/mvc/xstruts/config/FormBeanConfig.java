...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.DynaActionForm;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.DynaActionFormClass;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.validator.BeanValidatorForm;
...
public class FormBeanConfig extends BaseConfig {
    ...
    public void processExtends(ModuleConfig moduleConfig) throws ClassNotFoundException, IllegalAccessException,
        ...
        if ((!extensionProcessed) && (ancestor != null)) {
            ...
            // Check against circule inheritance and make sure the cn.eggsoft.sp34pricereport.base config's
            ...
            // Copy values from the cn.eggsoft.sp34pricereport.base config
