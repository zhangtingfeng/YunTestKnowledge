package cn.tedu.sp0ag4studio.core.mvc.xstruts.chain;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.RequestProcessor;
...
public class ComposableRequestProcessor extends RequestProcessor {
    ...
    /**
     * <p>
     * The {@link CatalogFactory} from which catalog containing the the cn.eggsoft.sp34pricereport.base
     ...
     * </p>
     * <p>
     * The cn.eggsoft.sp34pricereport.base implementation simply calls CatalogFactory.getInstance(), unless
     ...
     * the request-processing command. In the cn.eggsoft.sp34pricereport.base implementation, if this value
