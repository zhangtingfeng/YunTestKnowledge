package cn.tedu.sp0ag4studio.core.mvc.xstruts.util;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionServlet;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionServletWrapper;
...
import cn.tedu.sp0ag4studio.core.mvc.xstruts.upload.MultipartRequestHandler;
import cn.tedu.sp0ag4studio.core.mvc.xstruts.upload.MultipartRequestWrapper;

/**
 * <p>
 * General purpose utility methods related to processing a servlet request in
 * the Struts cn.eggsoft.sp34pricereport.controller framework.
 * </p>
 *
...
public class RequestUtils {
    ...
    public static void populate(Object bean, String prefix, String suffix, HttpServletRequest request)
        ...
        if ((contentType != null) && (contentType.startsWith("multipart/form-data"))
            ...
            if (bean instanceof ActionForm) {
                ...
                throw new ServletException("bean that's supposed to be "
                        ...
                        + "\"cn.tedu.sp0ag4studio.core.mvc.xstruts.action.ActionForm\", but type " + "\""
        ...
        while (names.hasMoreElements()) {
            ...
            // such as 'cn.tedu.sp0ag4studio.core.mvc.xstruts.action.CANCEL'
            if (!(stripped.startsWith("cn.tedu.sp0ag4studio.core.mvc.xstruts."))) {
     ...
     * @param pattern URL pattern used to map the cn.eggsoft.sp34pricereport.controller servlet
