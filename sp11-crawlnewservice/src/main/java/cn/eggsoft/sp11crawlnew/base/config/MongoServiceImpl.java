package cn.eggsoft.sp11crawlnew.base.config;
...
public class MongoServiceImpl {
    ...
    public String savelog(String Logs_Subject, String Logs_SubSubject, Exception e) throws ParseException, IOException, JSONException {
       String strErr="";
        if (e == null){
            strErr= "";
        }
        ...
        strErr=stringWriter.toString();
        savelog( Logs_Subject,  Logs_SubSubject, strErr);
       return strErr;
     ...
     * @throws IOException
     */
    public JSONObject savelog(String Logs_Subject, String Logs_SubSubject, String Logs_Content) throws
    ...
    public JSONObject savelog(String Logs_Subject, String Logs_SubSubject, Object Logs_Content) throws
            ParseException, IOException, JSONException {
...
class ThreadSaveLog extends Thread {
    ...
    public void run() {
        try {
            String strtemplateEureka = String.format("http://%s/%s/MongoLog/save", "mongodb-service", "mongodb-service");
            System.out.println("strtemplateEureka " + strtemplateEureka);
            templateEureka.postForObject(strtemplateEureka, (objectITEM), JsonResult.class);
        } catch (Exception ee) {
            ee.printStackTrace();
            System.out.println("Running " + ee.getLocalizedMessage());
        }
