...
class AipOcr(AipBase):
    ...
    __HuaWeiTokenURL = "https://iam.cn-north-4.myhuaweicloud.com/v3/auth/tokens"

    __HuaWeigeneraltextURL = "https://ocr.cn-north-4.myhuaweicloud.com/v2/0cd497449880f5cf2f75c01a7af557f7/ocr/general-text"

    def HuaWeiToken(self, options=None):
        ...
        return self._request(self.__HuaWeiTokenURL, data, "HUAWEI_X-Subject-Token" , None)

    def HuaWeiText(self, image64=None,options=None):
        """
            通用文字识别
        """
        options = options or {}
        ...
        "X-Auth-Token":options["X-Subject-Token"]
        }
        json_str = json.dumps(data)

        return self._request(self.__HuaWeigeneraltextURL, json_str,"",header)
